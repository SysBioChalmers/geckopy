"""Tests for kcat_sensitivity_analysis.bayesian.cmaes_tuning.
...
from geckopy.kcat_sensitivity_analysis.bayesian.cmaes_tuning import (
    cmaes_kcat_tuning,
...
def test_cmaes_tuning_moves_kcats_toward_truth(tmp_path):
    ...
    assert result.diagnostics_trace == []
