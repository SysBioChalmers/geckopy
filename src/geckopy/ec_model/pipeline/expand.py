...
canonical home in raven-python (which uses cobrapy's GPR AST instead of
RAVEN's string manipulation, matching the geckopy version). geckopy re-exports
it from raven-python under the same name so the rest of the pipeline is
unaffected.
"""
from __future__ import annotations

# Re-export from raven-python — see module docstring for the migration history.
from raven_python.manipulation.expand import expand_model
